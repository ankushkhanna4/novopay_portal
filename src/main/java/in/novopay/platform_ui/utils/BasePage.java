...
public class BasePage extends JavaUtils {
	...
	/**
	 * @return AndroidDriver, To launch the app using its activity and package on a particular device
	 * mentioned across the test case in the test-data
	 */
	...
	/**
	 * This method will Capture screenshot on failed test script, save in Screenshots folder
	 * @param result, Tcid
	 */
