...
public class ProfileTest {
	...
	public void profileTest(HashMap<String, String> usrData) throws InterruptedException, AWTException, ClassNotFoundException, IOException{
		...
		if (testOn.toUpperCase().equals("MOBILE")) {
			...
			wProfilePage = new ProfilePage(wdriver);
			
			wProfilePage.profile(usrData);
