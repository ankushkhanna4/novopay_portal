...
public class AddRetailerTest {
	String featureName = "Add Retailer page";
	public AndroidDriver<MobileElement> mdriver;
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private AddRetailerPage wAddRetailerPage;
	private Map<String, String> usrData;
	public String sheetname = "AddRetailerPage", workbook="UITestData";
	...
	public void addRetailerTest(HashMap<String, String> usrData) throws InterruptedException, AWTException, IOException{
		...
		if (testOn.toUpperCase().equals("MOBILE")) {
			...
			wAddRetailerPage = new AddRetailerPage(wdriver);
			
			wAddRetailerPage.addRetailer(usrData);
