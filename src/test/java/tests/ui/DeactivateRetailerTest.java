...
import in.novopay.platform_ui.pages.web.DeactivateRetailerPage;
...
public class DeactivateRetailerTest {
	String featureName = "Deactivate Retailer page";
	public AndroidDriver<MobileElement> mdriver;
	public WebDriver wdriver;
	private BasePage mBasePage = new BasePage(wdriver);
	private DeactivateRetailerPage wDeactivateRetailerPage;
	private Map<String, String> usrData;
	public String sheetname = "DeactivateRetailerPage", workbook="UITestData";
	...
	public void deactivateRetailerTest(HashMap<String, String> usrData) throws InterruptedException, AWTException, IOException{
		...
		if (testOn.toUpperCase().equals("MOBILE")) {
			...
			wDeactivateRetailerPage = new DeactivateRetailerPage(wdriver);
			
			wDeactivateRetailerPage.deactivateRetailer(usrData);
