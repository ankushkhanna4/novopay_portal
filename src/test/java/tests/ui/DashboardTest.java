...
public class DashboardTest {
	...
	private DashboardPage wDashboardPage;
	private Map<String, String> usrData;
	public String sheetname = "DashboardPage", workbook="UITestData";
	...
	public void dashboardTest(HashMap<String, String> usrData) throws InterruptedException, AWTException{
		...
		if (testOn.toUpperCase().equals("MOBILE")) {
			...
			wDashboardPage = new DashboardPage(wdriver);
			
			wDashboardPage.dashboard(usrData);
