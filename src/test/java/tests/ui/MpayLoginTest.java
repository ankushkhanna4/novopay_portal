...
import in.novopay.platform_ui.pages.web.MpayLoginPage;
...
public class MpayLoginTest {
	...
	public void mpayLoginTest(HashMap<String, String> usrData){
		...
		if (testOn.toUpperCase().equals("MOBILE")) {
			...
			wLoginPage = new MpayLoginPage(wdriver);
