...
import in.novopay.platform_ui.pages.web.OpsLogoutPage;
...
public class OpsLogoutTest {
	...
	public void opsLogoutTest(HashMap<String, String> usrData) throws AWTException{
		...
		if (testOn.toUpperCase().equals("MOBILE")) {
			...
			wLogoutPage = new OpsLogoutPage(wdriver);
