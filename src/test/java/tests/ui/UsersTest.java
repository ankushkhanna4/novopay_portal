...
public class UsersTest {
	...
	public void usersTest(HashMap<String, String> usrData) throws InterruptedException, AWTException, ClassNotFoundException{
		...
		if (testOn.toUpperCase().equals("MOBILE")) {
			...
			wDashboardPage = new UsersPage(wdriver);
			
			wDashboardPage.users(usrData);
